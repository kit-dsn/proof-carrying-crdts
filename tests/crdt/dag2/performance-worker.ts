...
const [_, initial_update]: [Update, ValidDag] = await proveUpdate('initial update', Field(0), [])


section(`${number_of_predecessors} predecessors`)
const predecessors: ValidDag[] = Array(number_of_predecessors).fill(initial_update)
